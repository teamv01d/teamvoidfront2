<template>
  <div>
      ...
      <div v-if="currentItem !== null">
          <v-row class="banner">
          <v-img 
          :src="require(`../assets/CompanyLogos/${currentItem.CompanyLogo}`)" 
          class="CompanyLogo"
          >
          </v-img>
           <v-col class="text">
          ...
          <p>{{currentItem.DateStart}}</p>      
          <p>{{currentItem.DateEnd}}</p>   
          </v-col>
    ...
    >
      ...
      <v-row class="contact">
          ...
          <v-col>
              <div class="contacts">
              <h2>{{currentItem.Phone}}</h2>
              <h2>{{currentItem.Mail}}</h2>
              <h2>{{currentItem.CompanyUrl}}</h2>
              </div>
          </v-col>
      </v-row>
    </v-card-text>
